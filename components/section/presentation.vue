    ...
    <div class="flex flex-col gap-4">
        ...
        <div class="flex">
            <a href="mailto:contato@brunoreis.dev"
                class="bg-black dark:bg-white dark:text-black hover:opacity-80 cursor-pointer rounded-md text-white font-bold transition-all ease-in-out duration-200 w-full md:w-auto py-3 text-center px-4 shadow-lg">Solicitar orçamento</a>
        </div>
    </div>
</template>