    ...
    <div class="flex flex-col gap-4">
        <div>
            <div class="my-8">
                ...
                <p class="text-lg">Desenvolvedor Web Fullstack Freelancer.</p>
                <SectionPresentationSkills />
            </div>
            <div class="text-gray-500 text-md flex flex-col gap-4 leading-relaxed">
        ...
        <div class="flex">
            <a href="mailto:contato@brunoreis.dev"
                class="bg-black hover:opacity-80 cursor-pointer rounded-md text-white font-bold transition-all ease-in-out duration-200 w-full md:w-auto py-3 text-center px-4 shadow-lg">Solicitar orçamento</a>
        </div>
    </div>
</template>